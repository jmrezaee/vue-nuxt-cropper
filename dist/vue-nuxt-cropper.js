...
(function (global, factory) {
  ...
  (global = global || self, global['vue-nuxt-cropper'] = factory(global.Cropper));
  ...
  var name = "vue-nuxt-cropper";
  var version = "1.0.0";
  var description = "💇 A simple image crop upload component for Vue, Nuxt";
  var author = "JMRezaee";
  var license = "MIT";
  var repository = {
  	type: "git",
  	url: "https://github.com/JMRezaee/vue-nuxt-cropper"
  };
  var keywords = [
  	"vue",
  	"mobile-web",
  ...
  var main = "dist/vue-nuxt-cropper.min.js";
  var module = "dist/vue-nuxt-cropper.esm.min.js";
  var scripts = {
    ...
    methods: {
      init: function init() {
        var options = _objectSpread({
          viewMode: 1,
          // Limit the crop box to no larger than the size of the canvas
          dragMode: 'move',
          // Move the canvas
          cropBoxMovable: false,
          // Move the crop box by dragging
          guides: false,
          ...
          // Double-click on the cropper to toggle drag mode between Crop and Move
      ...
      getCroppedBlob: function getCroppedBlob() {
        ...
        var quality = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.quality;
        return new Promise(function (resolve, reject) {
  ...
  var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
    if (!inject) return;
    inject("data-v-26a3cbac_0", {
      source: ".vue-nuxt-cropper{width:100%;height:100%;margin:auto;overflow:hidden;display:flex;justify-content:center;align-items:center}.vue-nuxt-cropper__img{width:100%}.vue-nuxt-cropper .cropper-container .cropper-view-box{outline:1px solid #fff;outline-color:#fff}.vue-nuxt-cropper .cropper-container .cropper-line{background-color:#fff}.vue-nuxt-cropper .cropper-container .cropper-point{background-color:#fff;opacity:1}.vue-nuxt-cropper .cropper-container .point-e,.vue-nuxt-cropper .cropper-container .point-n,.vue-nuxt-cropper .cropper-container .point-s,.vue-nuxt-cropper .cropper-container .point-w{display:none}.vue-nuxt-cropper .cropper-container .point-ne,.vue-nuxt-cropper .cropper-container .point-nw,.vue-nuxt-cropper .cropper-container .point-se,.vue-nuxt-cropper .cropper-container .point-sw{width:10px;height:10px;opacity:.8}",
      map: undefined,
      media: undefined
    });
  };
  ...
  var NuxtCropper = normalizeComponent_1({
